		...
		<form action="<?php echo $component_url; ?>" method="post" name="mod-magebridge-logout"
			...
			<ul>
				<?php if ($params->get('account_link', 2)) : ?>
					<li><a
						href="<?php echo $account_url; ?>"><?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_SETTINGS') ?></a>
					</li><?php endif; ?>
			</ul>
			<input type="submit" name="Submit" class="button"
				   value="<?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_LOGOUT') ?>"/>
		...
		<form action="<?php echo $component_url; ?>" method="post" name="mod-magebridge-login"
			...
			<div class="username-block">
				...
				<input class="inputbox" type="text" id="username_login" size="16"
					   ...
					   placeholder="<?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_EMAIL_PLACEHOLDER'); ?>"/>
			</div>
			<div class="password-block">
				<label for="password_login"><?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_PASSWORD') ?></label><br/>
				<input type="password" class="inputbox" id="password_login" size="16"
					   name="<?php echo $password_field; ?>" <?php echo $autocomplete; ?>
					   placeholder="<?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_PASSWORD_PLACEHOLDER'); ?>"/>
			</div>
			<div class="login-extras">
				<?php if (PluginHelper::isEnabled('system', 'remember')) : ?>
					<label for="remember_login"><?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_REMEMBER') ?></label>
					<input type="checkbox" name="remember" id="remember_login" value="yes" checked="checked"/>
				<?php endif; ?>
				<input type="submit" value="<?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_LOGIN') ?>" class="button"
					   name="Login"/>
				<ul>
					<li>
						<a href="<?php echo $forgotpassword_url; ?>"><?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_FORGOT_PASSWORD'); ?></a>
					</li>
					<li>
						<a href="<?php echo $createnew_url; ?>"><?php echo Text::_('MOD_MAGEBRIDGE_LOGIN_CREATE_ACCOUNT'); ?></a>
					</li>
				</ul>
				<input type="hidden" name="option" value="<?php echo $component ?>"/>
