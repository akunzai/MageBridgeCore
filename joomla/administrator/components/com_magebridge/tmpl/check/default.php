...
<td valign="top">
	...
	<table class="admintable" width="100%">
		<tr>
			...
			<td class="result"><?php echo sprintf(Text::_('COM_MAGEBRIDGE_CHECK_BROWSE_TEST_DESC'), 'index.php?option=com_magebridge&view=check&layout=browser'); ?></td>
		</tr>
		<tr>
			<td class="key"><?php echo Text::_('COM_MAGEBRIDGE_CHECK_PRODUCT_TEST'); ?></td>
			<td class="result"><?php echo sprintf(Text::_('COM_MAGEBRIDGE_CHECK_PRODUCT_TEST_DESC'), 'index.php?option=com_magebridge&view=check&layout=product'); ?></td>
		</tr>
		<tr>
	...
	<table class="admintable" width="100%">
	<?php foreach ($checks['compatibility'] ?? [] as $result) { ?>
	...
	<table class="admintable" width="100%">
	<?php if (!empty($checks['extension'])) { ?>
	<?php foreach ($checks['extension'] as $result) { ?>
	<tr class="check-row-<?php echo $result['status']; ?>">
		<td class="key" valign="top">
			<?php echo $result['text']; ?>
		</td>
	...
	<table class="admintable" width="100%">
	<?php foreach ($checks['bridge'] ?? [] as $result) { ?>
	<tr class="check-row-<?php echo $result['status']; ?>">
		<td class="key" valign="top">
			<?php echo $result['text']; ?>
		</td>
	...
	<table class="admintable" width="100%">
	<?php foreach (($checks['system'] ?? []) as $result) { ?>
	<tr class="check-row-<?php echo $result['status']; ?>">
		<td class="key" valign="top">
			<?php echo $result['text']; ?>
		</td>
	...
	<table class="admintable" width="100%">
	<?php foreach ($checks['extensions'] ?? [] as $result) { ?>
	<tr class="check-row-<?php echo $result['status']; ?>">
		<td class="key" valign="top">
			<?php echo $result['text']; ?>
		</td>
