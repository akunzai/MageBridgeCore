...
/** @var \MageBridge\Component\MageBridge\Administrator\View\Check\HtmlView $this */
...
<tr>
	...
	<td>
		<form method="post" name="adminForm" id="adminForm">
			<input class="browse" type="text" name="url" value="<?php echo $this->getUrl(); ?>" size="60" disabled />
...
<tr>
	...
	<td>
		<?php echo $this->getHost(); ?> (<?php echo Text::_('COM_MAGEBRIDGE_IPADDRESS'); ?>: <?php echo gethostbyname($this->getHost()); ?>)
	</td>
</tr>
<tr>
	<td class="key">
...
<div class="description">
<p>
Another thing to check is whether the Magento MageBridge-API is actually there. You can check this by opening up the URL <a target="_new" href="<?php echo $this->getUrl(); ?>"><?php echo $this->getUrl(); ?></a>. 
