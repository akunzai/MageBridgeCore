	...
	<thead>
		<tr>
			...
			<th width="150" class="title">
				<?php echo HTMLHelper::_('grid.sort', 'Name', 'u.name', $this->lists['order_Dir'] ?? 'asc', $this->lists['order'] ?? 'name'); ?>
			</th>
			<th width="150" class="title">
				<?php echo HTMLHelper::_('grid.sort', 'Username', 'u.username', $this->lists['order_Dir'] ?? 'asc', $this->lists['order'] ?? 'name'); ?>
			</th>
			<th width="150" class="title">
				<?php echo HTMLHelper::_('grid.sort', 'Email', 'u.email', $this->lists['order_Dir'] ?? 'asc', $this->lists['order'] ?? 'name'); ?>
			</th>
			<th width="150" class="title">
