...
class View extends CommonView
{
    ...
    public function __construct($config = [])
    {
        ...
        if ($this->model !== null && method_exists($this->model, 'getTable')) {
            $useTable = false;
    ...
    {
        if ($this->item !== null && isset($this->item->access)) {
    ...
    {
        $ordering = ($this->model !== null && method_exists($this->model, 'getOrderByDefault')) ? $this->model->getOrderByDefault() : null;

        if ($this->app->isClient('administrator') && !empty($ordering) && $ordering == 'ordering' && $this->model !== null && $this->item !== null) {
            if (method_exists($this->model, 'getOrderingQuery')) {
