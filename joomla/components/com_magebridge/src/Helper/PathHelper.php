...
class PathHelper
{
    ...
    /**
     * Get site component path.
     *
     * @return string Component path
     */
    public static function getComponentPath(): string
    {
        if (\defined('JPATH_COMPONENT')) {
            return (string) \constant('JPATH_COMPONENT');
        }

        return self::getSitePath() . '/components/com_magebridge';
    }

    /**
     * Get frontend component path.
     *
     * @return string Frontend component path
     */
    public static function getFrontComponentPath(): string
    {
        return self::getSitePath() . '/components/com_magebridge';
    }

    /**
     * Get backend component path.
     *
     * @return string Backend component path
     */
    public static function getAdminComponentPath(): string
    {
        return self::getAdministratorPath() . '/components/com_magebridge';
    }
