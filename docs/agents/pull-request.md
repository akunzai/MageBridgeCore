...
- **Product logic**: `joomla/**`, `magento/**`. A change here lands with its tests in the
  same request.
- **Exempt**: `docs/**`, `.devcontainer/**`, `.github/**`, `tests/**`, `manifest.xml`,
  `bundle.sh`, `bundle.php`, markdown files, scripts, and
